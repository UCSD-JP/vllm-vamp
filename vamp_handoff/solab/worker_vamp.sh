...
KVCFG="{\"kv_connector\":\"OffloadingConnector\",\"kv_role\":\"kv_both\",\"kv_connector_extra_config\":{\"spec_module_path\":\"vamp_probe\",\"spec_name\":\"VampOffloadingSpec\",\"cpu_bytes_to_use\":$CPU_BYTES,\"block_size_factor\":2,\"eviction_policy\":\"lru\"}}"
